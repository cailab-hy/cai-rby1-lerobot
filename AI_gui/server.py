...
def load_config() -> dict[str, Any]:
    ...
    if any(not task.get("voice_keywords") or not task.get("voice_response") for task in tasks):
        raise ValueError("Every task needs voice_keywords and voice_response")
